...
public class CompanyController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    **Use Case:** Browse and search companies in the system.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
    ...
    @Operation(
            summary = "List companies by active status",
            description = """
                    Retrieves a list of companies filtered by active status (active or inactive).
                    
                    **Access:** SUPERADMIN, COMPANYADMIN
                    
                    **Use Case:** Quick access to active or inactive companies without pagination.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @GetMapping("/isactive")
    public ResponseEntity<List<CompanyResponseDto>> listCompaniesByActive(
            @Parameter(description = "Filter by active status", example = "true", required = true)
    ...
    @Operation(
            ...
            description = """
                    Retrieves a list of all active companies.
                    
                    **Access:** SUPERADMIN, COMPANYADMIN
                    
                    **Use Case:** Quick access to active companies.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
    ...
    @Operation(
            summary = "List all inactive companies",
            description = """
                    Retrieves a list of all inactive companies.
                    
                    **Access:** SUPERADMIN, COMPANYADMIN
                    
                    **Use Case:** View deactivated companies.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
    ...
    @Operation(
            summary = "Search active companies by name",
            description = """
                    Searches for active companies by name (partial match, case-insensitive).
                    
                    **Access:** SUPERADMIN, COMPANYADMIN
                    
                    **Use Case:** Quick search for active companies by name.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @GetMapping("/active/search")
    public ResponseEntity<List<CompanyResponseDto>> searchActiveCompanies(
            @Parameter(description = "Company name to search for", example = "Acme", required = true)
    ...
    @Operation(
            summary = "Search inactive companies by name",
            description = """
                    Searches for inactive companies by name (partial match, case-insensitive).
                    
                    **Access:** SUPERADMIN, COMPANYADMIN
                    
                    **Use Case:** Quick search for inactive companies by name.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
    @GetMapping("/inactive/search")
    public ResponseEntity<List<CompanyResponseDto>> searchInactiveCompanies(
            @Parameter(description = "Company name to search for", example = "Acme", required = true)
            @RequestParam String name
    ) {
    ...
    @Operation(
            summary = "Search all companies by name",
            description = """
                    Searches for companies by name regardless of active status (partial match, case-insensitive).
                    
                    **Access:** SUPERADMIN, COMPANYADMIN
                    
                    **Use Case:** Quick search across all companies by name.
                    """,
            tags = {"Companies"},
            security = @SecurityRequirement(name = "Bearer Authentication")
    )
